...
%
%%
function [test_error_rate] = one_NN_ucr_euclidean(dataset_name, w, k)
% close all; clc;
...
mdl.Distance = @(x,Z)distfun_ucr_euclidean(x,Z, w/100);
...
fileID = fopen('Euclidean_distance_UCR.txt', 'a');
