/*
 * dtw_manhattan_mex.cpp - call MATLAB External Interfaces
 *
 * Computes the DTW_manhattan distance between two time series
 * Output is a 1x1 matrix
 * The calling syntax is:
 *
 *		outMatrix = dtw_manhattan(inMatrix_1, inMatrix_2)
 *
